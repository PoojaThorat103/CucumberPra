...
@When("^User click on button pop up message will display$")
public void user_click_on_button_pop_up_message_will_display() throws InterruptedException {
	practiceAction.HandleAlertsPopUp();
